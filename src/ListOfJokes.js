...
class ListOfJokes extends Component {
  ...
  render() {
    if (this.state.loading) {
      return (
        <div className='ListOfJokes-spinner'>
          <i className='far fa-8x fa-laugh fa-spin' />
          <h1 className='ListOfJokes-title'>Loading...</h1>
        </div>
      );
    }
    ...
    return (
      <div className='ListOfJokes'>
        <div className='ListOfJokes-sidebar'>
          <h1 className='ListOfJokes-title'>
            <span>Dad</span> Jokes
          </h1>
          <img src='https://assets.dryicons.com/uploads/icon/svg/8927/0eb14c71-38f2-433a-bfc8-23d9c99b3647.svg' />
          <button className='ListOfJokes-getmore' onClick={this.handleClick}>
            Fetch Jokes
          </button>
        </div>
